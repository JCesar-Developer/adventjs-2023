...
describe('Challenge 8', () => {
  ...
  it('2. Should return as many characterss as gifts less than ten and grouped in differents bags if necessary', () => {
    expect( organizeGifts('3a') ).toBe('(aaa)');
    expect( organizeGifts('5b') ).toBe('(bbbbb)');
    expect( organizeGifts('3a5b') ).toBe('(aaa)(bbbbb)');
  })

  it('3. Should return as many boxes as gifts multiples of 10 and grouped', () => {
    expect( organizeGifts('10a') ).toBe('{a}');
    expect( organizeGifts('20b') ).toBe('{b}{b}');
    expect( organizeGifts('10a20b') ).toBe('{a}{b}{b}');
  })

  it('4. Should return as many boxes as gifts multiples of 10 and bags with the reminders. And grouped', () => {
